    ...
    <section className="py-12 px-4 overflow-hidden">
      <div className="container mx-auto ">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-evenly gap-4 w-full">
          <div className="border border-[#59B5A6] pt-4 rounded-md mb-4 md:mb-0 w-full md:w-1/4 h-[218px] overflow-hidden" data-aos="fade-right">
          ...
          <div className="border border-[#59B5A6] pt-4 rounded-md mb-4 md:mb-0 w-full md:w-1/4 h-[218px] overflow-hidden" data-aos="fade-left">
            <h5 className="text-2xl font-extrabold text-[#59B5A6] mb-2 pl-4">
              for Startups:
            </h5>
            <ul className="text-[#212529]">
