    ...
    <section className="px-4 py-12 bg-[#EDFFEF]">
      <div className="container mx-auto md:flex flex-col items-center justify-center">
        ...
        <div className="my-6 flex flex-wrap items-stretch justify-center gap-4">
          <div className="overflow-hidden mb-4 md:mb-0 w-full md:w-2/5 lg:w-1/5 justify-center items-center text-center font-poppins  rounded-xl font-semibold border border-[#46af9f] group" data-aos="fade-up">
          ...
          <div className="overflow-hidden mb-4 md:mb-0 w-full md:w-2/5 lg:w-1/5 justify-center items-center text-center font-poppins  rounded-xl font-semibold border border-[#46af9f] group" data-aos="fade-up" data-aos-delay="200">
            <Tasks
          ...
          <div className="overflow-hidden mb-4 md:mb-0 w-full md:w-2/5 lg:w-1/5 justify-center items-center text-center font-poppins  rounded-xl font-semibold border border-[#46af9f] group" data-aos="fade-up" data-aos-delay="400">
          ...
          <div className="overflow-hidden mb-4 md:mb-0 w-full md:w-2/5 lg:w-1/5 justify-center items-center text-center font-poppins  rounded-xl font-semibold border border-[#46af9f] group" data-aos="fade-up" data-aos-delay="600">
            <Mentorship
              className="w-full h-fit transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] group-hover:scale-105"
